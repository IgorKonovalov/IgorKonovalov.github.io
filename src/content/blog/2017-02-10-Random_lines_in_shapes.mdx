...
date: 2017-02-10
tags: ['projects']
description: 'Random lines drawn inside SVG shapes - hexagons, squares, and triangles'
demo: 'random-lines-in-shape'
---

import RandomLinesInShape from '../../components/demos/RandomLinesInShape.astro';

I came to this small project after watching [video](https://www.youtube.com/watch?v=sJ6pMLp_IaI) by Daniel Shiffman
